// Intech Errors Edge Function: proxies GET /api-services/errors
// Returns the error catalog to map errorType codes to messages
...
Deno.serve(async (req) => {
  ...
  try {
    const resp = await withTimeout(fetch(`${BASE_URL}/api-services/errors`, {
      method: "GET",
      headers: {
